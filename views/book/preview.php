...
<div class="cont-desc span_1_of_2">
						   ...
						   <div id="products_example">
							   <div id="products">
								<div class="slides_container">
									<a href="#" target="_blank"><img src="<?=$booklol->hinhsach?>" alt=" " /></a>
				...
				<div class="desc span_3_of_2">
					<h2><?=$booklol->tensach?></h2>
					<p><?=$booklol->motasach?></p>					
					<div class="price">
						<p>Price: <span><?=$booklol->giasach?>$</span></p>
					</div>
					<div class="available">
				...
				<div class="share-desc">
					...
					<div class="button"><span><a href="?controller=cart&action=buy&id=<?=$booklol->idsach?>">Add to Cart</a></span></div>					
					<div class="clear"></div>
				</div>
				...
				<div class="grid_1_of_4 images_1_of_4">
					...
					<div class="price" style="border:none">
					       		<div class="add-cart" style="float:none">								
									<h4><a href="?controller=cart&action=buy&id=<?=$booklol->idsach?>">Add to Cart</a></h4>
							     </div>
							 <div class="clear"></div>
					</div>
				</div>
